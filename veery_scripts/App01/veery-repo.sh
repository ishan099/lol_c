...
cd /usr/src/;
docker run -d -t --memory="512m" -v /etc/localtime:/etc/localtime:ro --env="VERSION_TAG=$VERSION_TAG" --env="COMPOSE_DATE=$DATE" --env="NODE_CONFIG_DIR=/usr/local/src/queuemusic/config" --env="HOST_TOKEN=$HOST_TOKEN" --env="SYS_DATABASE_TYPE=$DATABASE_TYPE" --env="SYS_DATABASE_POSTGRES_USER=$DATABASE_POSTGRES_USER" --env="SYS_DATABASE_POSTGRES_PASSWORD=$DATABASE_POSTGRES_PASSWORD" --env="SYS_SQL_PORT=$SQL_PORT" --env="SYS_DATABASE_HOST=$DATABASE_HOST" --env="SYS_REDIS_HOST=$REDIS_HOST" --env="SYS_REDIS_PASSWORD=$REDIS_PASSWORD" --env="SYS_REDIS_PORT=$REDIS_PORT" --env="SYS_REDIS_MODE=$REDIS_MODE" --env="SYS_REDIS_SENTINEL_HOSTS=$REDIS_SENTINEL_HOSTS" --env="SYS_REDIS_SENTINEL_PORT=$REDIS_SENTINEL_PORT" --env="SYS_REDIS_SENTINEL_NAME=$REDIS_SENTINEL_NAME" --env="SYS_RABBITMQ_HOST=$RABBITMQ_HOST" --env="SYS_RABBITMQ_PORT=$RABBITMQ_PORT" --env="SYS_RABBITMQ_USER=$RABBITMQ_USER" --env="SYS_RABBITMQ_PASSWORD=$RABBITMQ_PASSWORD" --env="SYS_MONGO_HOST=$MONGO_HOST" --env="SYS_MONGO_USER=$MONGO_USER" --env="SYS_MONGO_PASSWORD=$MONGO_PASSWORD"  --env="SYS_MONGO_DB=$MONGO_DB" --env="SYS_MONGO_PORT=$MONGO_PORT" --env="SYS_MONGO_REPLICASETNAME=$MONGO_REPLICA_SET_NAME" --env="HOST_NAME=queuemusic" --env="HOST_QUEUEMUSIC_PORT=8843" --env="HOST_IP=$HOST_IP" --env="HOST_VERSION=$HOST_VERSION" --env="VIRTUAL_HOST=queuemusic.*" --env="LB_FRONTEND=queuemusic.$FRONTEND" --env="LB_PORT=$LB_PORT" --expose=8843/tcp --log-opt max-size=10m --log-opt max-file=10 --restart=always --name queuemusic queuemusic:$VERSION_TAG node /usr/local/src/queuemusic/app.js;
;;
   "appregistry")
#27
cd /usr/src/;
...
docker run -d -t --memory="512m" -v /etc/localtime:/etc/localtime:ro --env="VERSION_TAG=$VERSION_TAG" --env="COMPOSE_DATE=$DATE" --env="NODE_CONFIG_DIR=/usr/local/src/integrationapi/config" --env="HOST_TOKEN=$HOST_TOKEN" --env="HOST_INTEGRATIONAPI_PORT=8882" --env="HOST_VERSION=$HOST_VERSION" --env="SYS_REDIS_HOST=$REDIS_HOST" --env="SYS_REDIS_PASSWORD=$REDIS_PASSWORD" --env="SYS_REDIS_PORT=$REDIS_PORT" --env="SYS_REDIS_MODE=$REDIS_MODE" --env="SYS_REDIS_SENTINEL_HOSTS=$REDIS_SENTINEL_HOSTS" --env="SYS_REDIS_SENTINEL_PORT=$REDIS_SENTINEL_PORT" --env="SYS_REDIS_SENTINEL_NAME=$REDIS_SENTINEL_NAME" --env="SYS_RABBITMQ_HOST=$RABBITMQ_HOST" --env="SYS_RABBITMQ_PORT=$RABBITMQ_PORT" --env="SYS_RABBITMQ_USER=$RABBITMQ_USER" --env="SYS_RABBITMQ_PASSWORD=$RABBITMQ_PASSWORD" --env="SYS_MONGO_HOST=$MONGO_HOST" --env="SYS_MONGO_USER=$MONGO_USER" --env="SYS_MONGO_PASSWORD=$MONGO_PASSWORD"  --env="SYS_MONGO_DB=$MONGO_DB" --env="SYS_MONGO_PORT=$MONGO_PORT" --env="SYS_MONGO_REPLICASETNAME=$MONGO_REPLICA_SET_NAME" --env="SYS_USERSERVICE_HOST=userservice.$FRONTEND" --env="SYS_USERSERVICE_VERSION=$HOST_VERSION" --env="SYS_USERSERVICE_PORT=$LB_PORT" --env="VIRTUAL_HOST=integrationapi.*" --env="LB_FRONTEND=integrationapi.$FRONTEND" --env="LB_PORT=$LB_PORT" --expose=8882/tcp -p 8882:8882 --log-opt max-size=10m --log-opt max-file=10 --restart=always --name integrationapi integrationapi:$VERSION_TAG node /usr/local/src/integrationapi/app.js;
;;
...
if [ $REPOSITORY = "local" ]; then
IFS='.' read -ra VER <<< "$GO_VERSION_TAG"
 docker pull $REPOSITORY_IPURL":5000"/"dashboarddataprocessor:"$GO_VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"dashboarddataprocessor:"$GO_VERSION_TAG "dashboarddataprocessor:"$GO_VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"dashboarddataprocessor:"$GO_VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
#docker run -d -t --memory="512m" -v /etc/localtime:/etc/localtime:ro --env="VERSION_TAG=$GO_VERSION_TAG" --env="COMPOSE_DATE=$DATE" --env="GO_CONFIG_DIR=/go/src/gopkg.in/DuoSoftware/DVP-DashboardDataProcessor.${VER[0]}/DashboardDataProcessor" --env="HOST_TOKEN=$HOST_TOKEN" --env="HOST_IP=$HOST_IP" --env="HOST_VERSION=$HOST_VERSION" --env="SYS_DASHBOARD_REDIS_HOST=$DASHBOARD_REDIS_HOST" --env="SYS_DASHBOARD_REDIS_PORT=$DASHBOARD_REDIS_PORT" --env="SYS_REDIS_DB_DASHBOARD=$REDIS_DB_DASHBOARD" --env="SYS_DASHBOARD_REDIS_PASSWORD=$DASHBOARD_REDIS_PASSWORD" --env="SYS_DATABASE_POSTGRES_USER=$DATABASE_POSTGRES_USER" --env="SYS_DATABASE_POSTGRES_PASSWORD=$DATABASE_POSTGRES_PASSWORD" --env="SYS_DATABASE_HOST=$DATABASE_HOST" --env="SYS_SQL_PORT=$SQL_PORT" --env="SYS_REDIS_SENTINEL_NAME=$REDIS_SENTINEL_NAME" --env="SYS_REDIS_MODE=$REDIS_MODE" --env="SYS_REDIS_SENTINEL_HOSTS=$REDIS_SENTINEL_HOSTS" --env="SYS_REDIS_SENTINEL_PORT=$REDIS_SENTINEL_PORT" --env="SYS_RABBITMQ_HOST=$RABBITMQ_HOST" --env="SYS_RABBITMQ_PORT=$RABBITMQ_PORT" --env="SYS_RABBITMQ_USER=$RABBITMQ_USER" --env="SYS_RABBITMQ_PASSWORD=$RABBITMQ_PASSWORD" --env="SYS_MONGO_HOST=$MONGO_HOST" --env="SYS_MONGO_USER=$MONGO_USER" --env="SYS_MONGO_PASSWORD=$MONGO_PASSWORD"  --env="SYS_MONGO_DB=$MONGO_DB" --env="SYS_MONGO_PORT=$MONGO_PORT" --env="SYS_MONGO_REPLICASETNAME=$MONGO_REPLICA_SET_NAME" --log-opt max-size=10m --log-opt max-file=10 --restart=always --name dashboarddataprocessor dashboarddataprocessor:$GO_VERSION_TAG go run *.go;
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"articleservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"articleservice:"$VERSION_TAG "articleservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"articleservice:"$VERSION_TAG;
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"contactbasednumberdialingservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"contactbasednumberdialingservice:"$VERSION_TAG "contactbasednumberdialingservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"contactbasednumberdialingservice:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
if [ ! -d "DVP-ContactBasedNumberDialingService" ]; then
        git clone -b $VERSION_TAG https://github.com/DuoSoftware/DVP-ContactBasedNumberDialingService.git;
fi
cd DVP-ContactBasedNumberDialingService;
fi
cd /usr/src/;
docker run -d -t --memory="512m" -v /etc/localtime:/etc/localtime:ro --env="VERSION_TAG=$VERSION_TAG" --env="COMPOSE_DATE=$DATE" --env="NODE_CONFIG_DIR=/usr/local/src/contactbasednumberdialingservice/config" --env="HOST_TOKEN=$HOST_TOKEN" --env="HOST_VERSION=$HOST_VERSION" --env="HOST_CONTACTBASEDNUMBERDIALINGSERVICE_PORT=8899" --env="SYS_DATABASE_HOST=$DATABASE_HOST" --env="SYS_DATABASE_TYPE=$DATABASE_TYPE" --env="SYS_DATABASE_POSTGRES_USER=$DATABASE_POSTGRES_USER" --env="SYS_DATABASE_POSTGRES_PASSWORD=$DATABASE_POSTGRES_PASSWORD" --env="SYS_SQL_PORT=$SQL_PORT" --env="SYS_MONGO_HOST=$MONGO_HOST" --env="SYS_MONGO_USER=$MONGO_USER" --env="SYS_MONGO_PASSWORD=$MONGO_PASSWORD"  --env="SYS_MONGO_DB=$MONGO_DB" --env="SYS_MONGO_PORT=$MONGO_PORT" --env="SYS_MONGO_REPLICASETNAME=$MONGO_REPLICA_SET_NAME" --env="SYS_REDIS_HOST=$REDIS_HOST" --env="SYS_REDIS_PASSWORD=$REDIS_PASSWORD" --env="SYS_REDIS_PORT=$REDIS_PORT" --env="SYS_REDIS_MODE=$REDIS_MODE" --env="SYS_REDIS_SENTINEL_HOSTS=$REDIS_SENTINEL_HOSTS" --env="SYS_REDIS_SENTINEL_PORT=$REDIS_SENTINEL_PORT" --env="SYS_NOTIFICATIONSERVICE_HOST=notificationservice.$FRONTEND" --env="SYS_NOTIFICATIONSERVICE_PORT=8089" --env="SYS_NOTIFICATIONSERVICE_VERSION=1.0.0.0" --env="SYS_REDIS_SENTINEL_NAME=$REDIS_SENTINEL_NAME" --env="VIRTUAL_HOST=contactbasednumberdialingservice.*" --env="LB_FRONTEND=contactbasednumberdialingservice.$FRONTEND" --env="LB_PORT=$LB_PORT" --expose=8899/tcp --log-opt max-size=10m --log-opt max-file=10 --restart=always --name contactbasednumberdialingservice contactbasednumberdialingservice:$VERSION_TAG node /usr/local/src/contactbasednumberdialingservice/app.js;
;;

  "cdrengine")
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"cdrengine:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"cdrengine:"$VERSION_TAG "cdrengine:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"cdrengine:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
if [ ! -d "DVP-CDREngine" ]; then
        git clone -b $VERSION_TAG https://github.com/DuoSoftware/DVP-CDREngine.git;
fi
cd DVP-CDREngine;
...
"3rdpartyauthconnector")
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"3rdpartyauthconnector:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"3rdpartyauthconnector:"$VERSION_TAG "3rdpartyauthconnector:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"3rdpartyauthconnector:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
if [ ! -d "DVP-3RdPartyAuthConnector" ]; then
        git clone -b $VERSION_TAG https://github.com/DuoSoftware/DVP-3RdPartyAuthConnector.git;
fi
cd DVP-3RdPartyAuthConnector;
docker build --build-arg VERSION_TAG=$VERSION_TAG -t "3rdpartyauthconnector:"$VERSION_TAG .;
fi
cd /usr/src/;

docker run -d -t --memory="512m" -v /etc/localtime:/etc/localtime:ro --env="VERSION_TAG=$VERSION_TAG" --env="COMPOSE_DATE=$DATE" --env="NODE_CONFIG_DIR=/usr/local/src/3rdpartyauthconnector/config" --env="HOST_TOKEN=$HOST_TOKEN" --env="HOST_VERSION=$HOST_VERSION" --env="HOST_3RDPARTYAUTHCONNECTOR_PORT=3639" --env="SYS_DATABASE_HOST=$DATABASE_HOST" --env="SYS_DATABASE_TYPE=$DATABASE_TYPE" --env="SYS_DATABASE_POSTGRES_USER=$DATABASE_POSTGRES_USER" --env="SYS_DATABASE_POSTGRES_PASSWORD=$DATABASE_POSTGRES_PASSWORD" --env="SYS_SQL_PORT=$SQL_PORT" --env="SYS_REDIS_HOST=$REDIS_HOST" --env="SYS_REDIS_PASSWORD=$REDIS_PASSWORD" --env="SYS_REDIS_PORT=$REDIS_PORT" --env="SYS_REDIS_MODE=$REDIS_MODE" --env="SYS_REDIS_SENTINEL_HOSTS=$REDIS_SENTINEL_HOSTS" --env="SYS_REDIS_SENTINEL_PORT=$REDIS_SENTINEL_PORT" --env="SYS_REDIS_SENTINEL_NAME=$REDIS_SENTINEL_NAME" --env="SYS_REDIS_DB_CONFIG=$REDIS_DB_CONFIG" --env="SYS_RABBITMQ_HOST=$RABBITMQ_HOST" --env="SYS_RABBITMQ_PORT=$RABBITMQ_PORT" --env="SYS_RABBITMQ_USER=$RABBITMQ_USER" --env="SYS_RABBITMQ_PASSWORD=$RABBITMQ_PASSWORD" --env="SYS_MONGO_HOST=$MONGO_HOST" --env="SYS_MONGO_USER=$MONGO_USER" --env="SYS_MONGO_PASSWORD=$MONGO_PASSWORD"  --env="SYS_MONGO_DB=$MONGO_DB" --env="SYS_MONGO_PORT=$MONGO_PORT" --env="SYS_MONGO_REPLICASETNAME=$MONGO_REPLICA_SET_NAME" --env="VIRTUAL_HOST=3rdpartyauthconnector.*" --env="LB_FRONTEND=3rdpartyauthconnector.$FRONTEND" --env="LB_PORT=$LB_PORT" --env="HOST_THIRD_PARTY_EVENT_URL=$HOST_THIRD_PARTY_EVENT_URL" --env="HOST_THIRD_PARTY_AUTH_SECRET=$HOST_THIRD_PARTY_AUTH_SECRET" --env="HOST_THIRD_PARTY_AUTH_URL=$HOST_THIRD_PARTY_AUTH_URL" --env="HOST_3RDPARTYAUTHCONNECTOR_PORT=3645"  --expose=3645/tcp -p 3645:3645 --log-opt max-size=10m --log-opt max-file=10 --restart=always --name 3rdpartyauthconnector 3rdpartyauthconnector:$VERSION_TAG node /usr/local/src/3rdpartyauthconnector/app.js;
;;
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"scheduletaskworker:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"scheduletaskworker:"$VERSION_TAG "scheduletaskworker:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"scheduletaskworker:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
if [ ! -d "DVP-ScheduleTaskWorker" ]; then
       git clone -b $VERSION_TAG https://github.com/DuoSoftware/DVP-ScheduleTaskWorker.git;
fi
